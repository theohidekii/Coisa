        ...
        <div className="relative container mx-auto px-4 md:px-6 py-12 md:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              <a 
                href="https://wa.me/5511992099917?text=Olá!%20Quero%20assistência%20técnica" 
                target="_blank" 
                rel="noreferrer"
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Avaliação Técnica</h3>
              <p className="text-gray-600">
                Nossa equipe faz uma visita técnica para avaliar o problema e fornecer orçamento
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Após aprovação do orçamento, nossa equipe executa o serviço com qualidade
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
             ...
             <div className="bg-blue-100 rounded-lg p-6 text-center shadow-md border border-blue-200">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-blue-100">(11) 99209-9917</p>
            </div>

            <div className="text-center">
              <Mail className="h-12 w-12 mx-auto mb-4 text-blue-200" />
              <h3 className="text-xl font-bold mb-2">E-mail</h3>
              <p className="text-blue-100">assistenciatecnicaeoficina@gmail.com</p>
            </div>

            <div className="text-center">
              <Clock className="h-12 w-12 mx-auto mb-4 text-blue-200" />
              <h3 className="text-xl font-bold mb-2">Horário</h3>
              <p className="text-blue-100">Seg a Sex: 7h30 às 17h30 | Sáb e Feriados: 7h30 às 13h</p>
            </div>
          </div>
