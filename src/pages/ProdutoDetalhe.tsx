    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
            ...
            <Card className="bg-blue-50 border-blue-200">
              <CardContent className="p-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="font-semibold text-blue-800">Informações de Entrega</span>
                </div>
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Características Principais</h3>
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Garantias e Suporte</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="flex items-start gap-3">
                  <Shield className="h-6 w-6 text-green-600 mt-1" />
                  <div>
                    <h4 className="font-semibold text-slate-900 mb-1">Garantia de Qualidade</h4>
                    <p className="text-sm text-slate-600">Produto com garantia de fábrica</p>
                  </div>
                </div>
                                 <div className="flex items-start gap-3">
                   <RotateCcw className="h-6 w-6 text-blue-600 mt-1" />
                   <div>
                     <h4 className="font-semibold text-slate-900 mb-1">Troca e Devolução</h4>
                     <p className="text-sm text-slate-600">7 dias para troca ou devolução</p>
                   </div>
                 </div>
                <div className="flex items-start gap-3">
                  <Package className="h-6 w-6 text-orange-600 mt-1" />
                  <div>
                    <h4 className="font-semibold text-slate-900 mb-1">Entrega Segura</h4>
                    <p className="text-sm text-slate-600">Produto embalado com segurança</p>
                  </div>
                </div>
              </div>
            </CardContent>
